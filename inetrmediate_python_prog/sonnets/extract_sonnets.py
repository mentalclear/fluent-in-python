...
sonnets = open("inetrmediate_python_prog/sonnets/extract_sonnets.py").readlines()
word_set = set([elt.strip() for elt in open("inetrmediate_python_prog/sonnets/sowpods.txt")])
sonnet_words = set()
...
f = open("inetrmediate_python_prog/sonnets/sonnet_words.txt", "w")
